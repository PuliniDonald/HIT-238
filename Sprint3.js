...
var containsClass=listItem.classList.contains("editMode");
		...
		//switch to .editmode label becomes the inputs value.
...
var taskCompleted=function(){
	...
	//Append the task list item to thecompleated tasks
	var listItem=this.parentNode;
...
//Set the click handler to the addTask function and holds it togethr
